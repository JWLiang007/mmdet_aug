...
def parse_args():
    ...
    parser.add_argument('--out-file', default=None, help='file path to output file')
...
def main():
    ...
    for image_path in images:
        ...
        if args.out_file:
            mmcv.mkdir_or_exist(os.path.dirname(args.out_file))
 
            mmcv.imwrite(image_with_bounding_boxes, args.out_file)
        elif args.out_dir:
